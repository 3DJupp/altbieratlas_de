...
const ROUTES = [
  ...
  ["GET",    "/api/admin/breweries/:id/styles",            R.adminGetBreweryStyles],
  ["PUT",    "/api/admin/breweries/:id/styles",            R.adminSetBreweryStyles],
  ["GET",    "/api/admin/validate-reset-token",            R.adminValidateResetToken],
  ...
  ["POST",   "/api/admin/glossary",                        R.adminCreateGlossaryEntry],
  ["PUT",    "/api/admin/glossary/:term",                  R.adminUpdateGlossaryEntry],
  ["DELETE", "/api/admin/glossary/:term",                  R.adminDeleteGlossaryEntry],
  ["GET",    "/api/admin/prices",                          R.adminListPrices],
  ["POST",   "/api/admin/prices",                          R.adminCreatePrice],
