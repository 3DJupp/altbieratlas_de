...
(function () {
  ...
  const LIVE = {
    ...
    admin: {
      ...
      uploadBreweryLogo:      (id, file) => upload(`/admin/breweries/${encodeURIComponent(id)}/logo`, file, "logo"),
      deleteBreweryLogo:      (id) => req(`/admin/breweries/${encodeURIComponent(id)}/logo`, { method: "DELETE" }),
      listBreweryLogos:       () => req("/admin/ort-logos"),
      deleteBreweryLogoFile:  (key) => req(`/admin/ort-logos/${encodeURIComponent(key)}`, { method: "DELETE" }),
  ...
  window.AtlasAPI = {
    ...
    admin: {
      ...
      uploadBreweryLogo:      (id, f) => window.AtlasAPI.admin._gate("uploadBreweryLogo", id, f),
      deleteBreweryLogo:      (id) => window.AtlasAPI.admin._gate("deleteBreweryLogo", id),
      listBreweryLogos:       () => window.AtlasAPI.admin._gate("listBreweryLogos"),
      deleteBreweryLogoFile:  (key) => window.AtlasAPI.admin._gate("deleteBreweryLogoFile", key),
