...
window.ATLAS_I18N = {
  de: {
    ...
    "field.eventDate": "Startdatum",
    "field.eventEndDate": "Enddatum (optional, für mehrtägige Events)",
    ...
    // Types (Brauereiarten) — DB-Werte und Legacy-i18n-Schlüssel
    ...
    "admin.styles": "Bierstile",
    "admin.venueTypes": "Venue-Typen",
    "admin.events": "Events",
    "admin.prices": "Preise",
    "admin.stylesSub": "Alle Bierstile — Bezeichnungen und Werte bearbeiten.",
    "admin.venueTypesSub": "Anzeigebezeichnungen der Venue-Typen bearbeiten.",
    "admin.eventsSub": "Alle Termine verwalten.",
    "admin.pricesSub": "Alle Preismeldungen.",
    "admin.newStyle": "+ Neuen Stil anlegen",
    "admin.newEvent": "+ Neues Event",
    "admin.styleEditTitle": "Bierstil bearbeiten",
    "admin.styleCreateTitle": "Neuen Bierstil anlegen",
    "admin.eventEditTitle": "Event bearbeiten",
    "admin.eventCreateTitle": "Neues Event anlegen",
    "admin.priceEditTitle": "Preismeldung bearbeiten",
    "admin.colTitle": "Titel",
    "admin.colTitleDe": "Titel (DE)",
    "admin.colTitleEn": "Titel (EN)",
    "admin.colDate": "Datum",
    "admin.colEndDate": "Enddatum",
    "admin.colTime": "Uhrzeit",
    "admin.colBrewery": "Brauerei",
    "admin.colLocation": "Ort",
    "admin.colDescDe": "Beschreibung (DE)",
    "admin.colDescEn": "Description (EN)",
    "admin.colSize": "Größe",
    "admin.colPrice": "Preis",
    "admin.colSource": "Quelle",
    "admin.colNotes": "Notiz",
    "admin.colId": "ID",
    "admin.colAbv": "ABV",
    "admin.colIbu": "IBU",
    "admin.colLabelDe": "Label (DE)",
    "admin.colLabelEn": "Label (EN)",
    "admin.colTastingDe": "Geschmack (DE)",
    "admin.colTastingEn": "Geschmack (EN)",
    "admin.editSave": "Speichern",
    "admin.editCancel": "Abbrechen",
    "admin.editTitle": "Eintrag bearbeiten",
  ...
  en: {
    ...
    "field.eventDate": "Start date",
    "field.eventEndDate": "End date (optional, for multi-day events)",
    ...
    // Types — DB values and legacy i18n keys
    "type.brewery": "Brewpub",
    "type.pub": "Bar / Restaurant",
    "type.shop": "Retail",
    ...
    "admin.styles": "Beer Styles",
    "admin.venueTypes": "Venue Types",
    "admin.events": "Events",
    "admin.prices": "Prices",
    "admin.stylesSub": "All beer styles — edit labels and values.",
    "admin.venueTypesSub": "Edit display labels for venue types.",
    "admin.eventsSub": "Manage all events.",
    "admin.pricesSub": "All price reports.",
    "admin.newStyle": "+ Add Beer Style",
    "admin.newEvent": "+ New Event",
    "admin.styleEditTitle": "Edit Beer Style",
    "admin.styleCreateTitle": "Add Beer Style",
    "admin.eventEditTitle": "Edit Event",
    "admin.eventCreateTitle": "New Event",
    "admin.priceEditTitle": "Edit Price Report",
    "admin.colTitle": "Title",
    "admin.colTitleDe": "Title (DE)",
    "admin.colTitleEn": "Title (EN)",
    "admin.colDate": "Date",
    "admin.colEndDate": "End Date",
    "admin.colTime": "Time",
    "admin.colBrewery": "Brewery",
    "admin.colLocation": "Location",
    "admin.colDescDe": "Description (DE)",
    "admin.colDescEn": "Description (EN)",
    "admin.colSize": "Size",
    ...
    "admin.colLabelDe": "Label (DE)",
    "admin.colLabelEn": "Label (EN)",
    "admin.colTastingDe": "Tasting (DE)",
    "admin.colTastingEn": "Tasting (EN)",
    "admin.editSave": "Save",
    "admin.editCancel": "Cancel",
    "admin.editTitle": "Edit entry",
